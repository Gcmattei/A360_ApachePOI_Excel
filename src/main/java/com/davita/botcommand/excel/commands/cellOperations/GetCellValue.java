...
@BotCommand
@CommandPkg(
        documentation_url = "https://confluence.davita.com/spaces/PA/pages/993465649/Excel+Package+Documentation#ExcelPackageDocumentation-Getsinglecell",
...
public class GetCellValue {
    ...
    public Value<String> action(
            ...
            @Pkg(description = "[[GetCellValue.read.visible.description]]",default_value_type = DataType.STRING) String visibleHelp,
            @Idx(index = "2.2.1", type = AttributeType.HELP)
            @Pkg(description = "[[GetCellValue.read.value.description]]",default_value_type = DataType.STRING) String valueHelp,
