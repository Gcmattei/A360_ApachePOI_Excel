...
@BotCommand
@CommandPkg(
        documentation_url = "https://confluence.davita.com/spaces/PA/pages/993465649/Excel+Package+Documentation#ExcelPackageDocumentation-Getworksheetasdatatable",
...
public class GetWorksheetAsTable {
    ...
    public TableValue action(
            ...
            @Pkg(description = "[[GetWorksheetAsTable.readOption.visible.description]]",default_value_type = DataType.STRING) String visibleHelp,
            @Idx(index = "5.2.1", type = AttributeType.HELP)
            @Pkg(description = "[[GetWorksheetAsTable.readOption.value.description]]",default_value_type = DataType.STRING) String valueHelp,
