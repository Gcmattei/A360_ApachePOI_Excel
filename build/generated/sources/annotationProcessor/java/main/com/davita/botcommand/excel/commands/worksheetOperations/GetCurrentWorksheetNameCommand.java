...
public final class GetCurrentWorksheetNameCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(GetCurrentWorksheetNameCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    GetCurrentWorksheetName command = new GetCurrentWorksheetName();
