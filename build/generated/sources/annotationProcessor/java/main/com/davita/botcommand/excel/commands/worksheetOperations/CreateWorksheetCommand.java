package com.davita.botcommand.excel.commands.worksheetOperations;
...
public final class CreateWorksheetCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(CreateWorksheetCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    CreateWorksheet command = new CreateWorksheet();
    ...
    try {
      command.action((String)convertedParameters.get("sheetName"),(WorkbookSession)convertedParameters.get("session"));Optional<Value> result = Optional.empty();
