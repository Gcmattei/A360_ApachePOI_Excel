...
public final class SaveWorkbookCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SaveWorkbookCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    SaveWorkbook command = new SaveWorkbook();
    ...
    try {
      command.action((WorkbookSession)convertedParameters.get("session"));Optional<Value> result = Optional.empty();
