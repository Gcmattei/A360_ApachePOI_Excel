package com.davita.botcommand.excel.commands.cellOperations;
...
public final class DeleteCellRangeCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DeleteCellRangeCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    DeleteCellRange command = new DeleteCellRange();
    ...
    if(parameters.containsKey("deleteOption") && parameters.get("deleteOption") != null && parameters.get("deleteOption").get() != null) {
      convertedParameters.put("deleteOption", parameters.get("deleteOption").get());
      if(convertedParameters.get("deleteOption") !=null && !(convertedParameters.get("deleteOption") instanceof String)) {
        throw new BotCommandException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","deleteOption", "String", parameters.get("deleteOption").get().getClass().getSimpleName()));
      }
    }
    if(convertedParameters.get("deleteOption") == null) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.validation.notEmpty","deleteOption"));
    }
    if(convertedParameters.get("deleteOption") != null) {
      switch((String)convertedParameters.get("deleteOption")) {
        case "SHIFT_LEFT" : {
        ...
        default : throw new BotCommandException(MESSAGES_GENERIC.getString("generic.InvalidOption","deleteOption"));
      }
    }
    ...
    try {
      command.action((String)convertedParameters.get("targetMode"),(String)convertedParameters.get("cellOrRangeA1"),(String)convertedParameters.get("deleteOption"),(WorkbookSession)convertedParameters.get("session"));Optional<Value> result = Optional.empty();
